...
function toMenu() {
  ...
  var abcedario = document.getElementById("grid-container");
  var answer = document.getElementById("answer");
  var answer1 = document.getElementById("answer1");
  var indicaciones = document.getElementById("indicaciones"); 
  var indicacionesabc = document.getElementById("indicaciones-abc");  
  start.style.display = "none";
  menu.style.display = "inline";
  menu1.style.display = "none";
  abcedario.style.display = "none";
  indicaciones.style.display = "none";
  indicacionesabc.style.display = "none";
...
function toMenu1(n) {
  ...
  if(operacion === 1){
    menu1.style.display = "none"; 
    abcedario.style.display = "grid";
    answer1.style.display = "inline";
    tituloCuento.innerHTML = "Abecedario";
    tituloCuento.style.display = "inline";
    indicacionesabc.style.display = "inline";
  }else{
